    ...
    const questions = [
        {
            ...
            answers: [
                ...
                "Cuentos y leyendas", 
                "La leyenda del sol, la luna y princesa", 
                "La leyenda de las cinco águilas"
            ], 
            correctAnswer: "La leyenda de las cinco águilas blancas"
        },
        {
            question: "¿Según la leyenda que representan Zuhé y Chía?", 
            answers: [
                "La luna y el sol", 
                "El sol y las estrellas", 
                "El sol y la luna", 
                "La genio de los bosques y las montañas"
            ], 
            correctAnswer: "El sol y la luna"
        },
        {
            question: "¿Qué sorprendió a Caribay, cuando vio al cielo?", 
            answers: [
                "El resplandeciente sol de la tarde", 
                "Cinco águilas blancas volando", 
                "La sombra de las aves", 
                "El destello del arco iris"
            ], 
            correctAnswer: "Cinco águilas blancas volando"
        },
        {
            question: "¿Cómo se le conocía a Caribay?", 
            answers: [
                "Estrella de los bosques", 
                "Hija del sol y la luna", 
                "La genio de los bosques aromáticos", 
                "Mi bella genio"
            ], 
            correctAnswer: "La genio de los bosques aromáticos"
        },
        {
            question: "¿En la tradición indígena, a que da origen este evento?", 
            answers: [
                "La Sierra Nevada de Santa Marta", 
                "La Sierra del Cocuy", 
                "El parque Tayrona", 
                "Las Sierras Nevadas de Mérida"
            ], 
            correctAnswer: "Las Sierras Nevadas de Mérida"
        }
    ];
